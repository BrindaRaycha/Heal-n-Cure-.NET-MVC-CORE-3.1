...
namespace Patient_Side.Controllers
{
    public class PatMedicineController : Controller
    {
        ...
        {
            var medList = from d in _context1.MEDICINETB
                          where d.Medicine_Content == "Paracetamol"
                          select new Medicine
                          {
        ...
        public ActionResult Checkout(Order order, Bill bill)
        {
            ...
            string con = @"Data Source=DESKTOP-CRNQCT1\MSSQLSERVER01;Initial Catalog=18Jan;Integrated Security=True";
